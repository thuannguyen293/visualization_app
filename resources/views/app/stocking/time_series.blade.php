...
@section('content')
    <div class="row filter-area">
        <div class="col-md-12 filter-item" style="display: none;">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="btn-group element-2">
                        ...
                        <div class="select-group">
                            ...
                            <select name="waterbody_type" class="js-select2-active w-100" data-placeholders="{!!htmlentities(__('app.filter_all_waterbody_type'))!!}" id="waterbody_type">
                                <option></option>
                                <option value="AS">Alle Seen</option>
                                <option value="FG">{!!htmlentities('Fliessgewässer')!!}</option>
                            </select>
    ...
    <div class="row detail-area">
        <div class="col-md-12 detail-info-area">
            <h2 class="filter-information">{{ __('app.stocking')}}, Zeitreihe {{date("Y")-10}} - {{date("Y")-1}}, ganzer Kanton, Fliessgewässer, Alle Arten</h2>
...
@section('script_footer')
    ...
    <script>
        ...
        function UpdateChart() {
            ...
            ShowLoading();
            $.ajax({
                url: '{{route('home')}}/api/stocking/time_series/chart',
                type: "get",
                data: {
        ...
        function downloadImage() {
            ...
            if ($('.detail-chart-area').hasClass('active')){
                ...
                DownloadImagePDFCallback(canvas_temp, "stocking_time_series.pdf", $('.filter-information').html());
